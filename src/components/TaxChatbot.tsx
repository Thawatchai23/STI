...
import { sendChatMessage } from '../services/supabase';
...
export default function TaxChatbot() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { 
        role: 'assistant', 
        content: 'ขออภัยค่ะ เกิดข้อผิดพลาดในการเชื่อมต่อ กรุณาลองใหม่อีกครั้ง หรือติดต่อเจ้าหน้าที่โดยตรง' 
      }]);
    }
